...
class CastingTestCase(unittest.TestCase):
    ...
    def test_401_delete_actor_casting_assistant(self):
        ...
        res = self.client().delete('/actors/'+str(actor.id), headers=setup_auth('casting_assistant'))
        self.assertEqual(res.status_code, 401)
    ...
    def test_delete_actor_casting_director(self):
        ...
        res = self.client().delete('/actors/'+str(actor.id), headers=setup_auth('casting_director'))
        data = json.loads(res.data)    
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['success'], True)
    ...
    def test_delete_actor_executive_producer(self):
        ...
        res = self.client().delete('/actors/'+str(actor.id), headers=setup_auth('executive_producer'))
        data = json.loads(res.data)    
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['success'], True)
        self.assertEqual(int(data['deleted']), actor.id)
    ...
    def test_401_patch_movie_casting_assistant(self):
        ...
        movie.insert()
        res = self.client().patch('/movies/'+str(movie.id), json={'title':'updated_movie'},
                             headers=setup_auth('casting_assistant'))
        self.assertEqual(res.status_code, 401)
    ...
    def test_delete_movie_casting_assistant(self):
        ...
        res = self.client().delete('/movies/'+str(movie.id), headers=setup_auth('casting_assistant'))
        self.assertEqual(res.status_code, 401)
    ...
    def test_401_delete_movie_casting_director(self):
        ...
        res = self.client().delete('/movies/'+str(movie.id), headers=setup_auth('casting_director'))
        self.assertEqual(res.status_code, 401)
    ...
    def test_401_delete_movie_executive_producer(self):
        ...
        res = self.client().delete('/movies/'+str(movie.id), headers=setup_auth('executive_producer'))
        data = json.loads(res.data)   
    ...
    def test_401_delete_movie_fail(self):
        ...
        res = self.client().delete('/movies/'+str(movie.id), headers=setup_auth(''))
        self.assertEqual(res.status_code, 401)
